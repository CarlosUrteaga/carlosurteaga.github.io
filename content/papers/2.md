...
summary: "This paper presents a Socratic Agent: a small, auditable tutoring model that foregrounds the learner's reasoning using a loop Elicit → Structure → Test → Summarize." 
cover:
#    image: "/1s.png"
    alt: "Socratic"
