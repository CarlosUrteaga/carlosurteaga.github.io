...
description: "This paper shows how to classify two scorpion species from the Centruroides family." 
...
cover:
    alt: "Venomous scorpion classification"
editPost:
...
---
  ...
  ##### Figure 1A: Photographs of the two studied scorpions.
![ Centruroides limpidus.](/conielecomp2016CL.png)

##### Figure 1B: Photographs of the two studied scorpions.
![Centruroides noxius.](/conielecomp2016CN.png)
...
##### Figure 3: Error rate between the number of trees in the RF.
![Error rate between the number of trees in the RF.](/conielecomp2016errorRF.png)
